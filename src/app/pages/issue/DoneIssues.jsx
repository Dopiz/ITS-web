...
let DoneIssues = React.createClass({
    ...
    onRowSelect: function(row, isSelected) {
        if (!isSelected) {
            ...
            this.setState({
                selectedId: row.id,
                isAcceptable : (row.owner_id == window.localStorage.getItem("id"))?true:false,
                isSelected: isSelected
            });
        }
    },
        ...
        return (
            <div id="content">
              <IssueChangeStatusModal
                  ...
                  fetchData={this.fetchDoneIssues}
              />
                            ...
                            <JarvisWidget
                                ...
                                <header>
                                    <div className="hidden-xs col-sm-2 ">
                                        <h2><span className="widget-icon"> <i className="fa fa-table"/></span><Msg phrase=" Done Issues"/></h2>
                                    </div>
