...
let DevelopmentIssues = React.createClass({
    ...
    fetchDevelopmentIssues: function() {
        ...
        HTTPService.get("issue/getIssues?status='Development'", function(res) {
    ...
    render: function() {
        ...
        return (
            <div id="content">
                ...
                <IssueChangeStatusModal title="Finish Issue" data={this.state.selectedData} status="Development" action="Finish" fetchData={this.fetchDevelopmentIssues}/>
                                    ...
                                    <div className="hidden-xs col-sm-2 ">
                                        <h2>
                                            <span className="widget-icon">
                                                <i className="fa fa-table"/></span><Msg phrase=" In Progress Issues"/></h2>
                                    </div>
