...
let Tester = React.createClass({
    ...
    fetchUsers : function(){
        ...
        HTTPService.get('user/getUsers?title=Tester', function(res){
            var dataList = [];
                ...
                <div className="row hidden-xs">
                    <div className='col-md-12 big-breadcrumbs'>
                        <h1 className="page-title txt-color-blueDark">
                            ...
                            <a className="txt-color-blueDark" >Tester</a>
                        </h1>
                    </div>
                </div>
                            ...
                            <JarvisWidget
                                ...
                                <header>
                                    <div className="hidden-xs col-sm-2 ">
                                        <h2><span className="widget-icon"> <i className="fa fa-child"/></span><Msg phrase=" Tester"/></h2>
                                    </div>
