                ...
                <div className="row hidden-xs">
                    <div className='col-md-12 big-breadcrumbs'>
                        <h1 className="page-title txt-color-blueDark">
                            ...
                            <a className="txt-color-blueDark" >Manager</a>
                        </h1>
                    </div>
                </div>
                                ...
                                <div className="btn-group">
                                    <OverlayTrigger placement="top"
                                        ...
                                        <a onClick={this.buttonCreateUser}
                                           data-toggle="modal"
                                           data-target={(this.state.identity == "Admin") ? "#UserDialogModal" : null}
                                           disabled={!(this.state.identity == "Admin")}
                                ...
                                <div className="btn-group" >
                                    <OverlayTrigger placement="top"
                                        ...
                                        <a onClick={this.buttonEditUser}
                                            data-toggle="modal"
                                            data-target={(this.state.isSelected) && (this.state.identity == "Admin") ? "#UserDialogModal" : null}
                                            disabled={!((this.state.isSelected) && (this.state.identity == "Admin"))}
                            ...
                            <JarvisWidget
                                ...
                                <header>
                                    <div className="hidden-xs col-sm-2 ">
                                        <h2><span className="widget-icon"> <i className="fa fa-child"/></span><Msg phrase=" Manager"/></h2>
                                    </div>
